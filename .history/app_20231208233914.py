...
if __name__ == '__main__':
    ...
    tuple_palette = [tuple(l) for l in palette]
    rc = Pixie.recolour_palette(small, [[255,0,0],[0,255,0],[0,0,255],[255,255,0],[255,0,255],[0,255,255],[255,255,255],[0,0,0]], pixel_size=1)
    rc.show()
