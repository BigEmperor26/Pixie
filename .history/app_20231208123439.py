...
if __name__ == '__main__':
    ...
    edges = Image.fromarray(edges)
    edges.show()
    pixellated_edges = Pixie.pixellate_resize(edges, 10)
    pixellated = Pixie.pixellate_resize(small, 10)
    pixellated.show()
    Pixie.outline_pixels(pixellated, edges_edges,pixel_size=10).show()