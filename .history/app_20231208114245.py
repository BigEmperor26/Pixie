...
if __name__ == '__main__':
    ...
    # CONVERT TO RGBA
    # show image
    pixellated = Pixie.pixellate(img_rc, 15)
    # pixellated.show()
    ...
    recoloured_custom = Pixie.recolour_palette(pixellated, res, pixel_size=15)
    ...
    closing_post = cv2.morphologyEx(edges, cv2.MORPH_CLOSE, kernel)
    Image.fromarray(closing_post).show()
