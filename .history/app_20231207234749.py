...
if __name__ == '__main__':
    ...
    sovraimposed = Pixie.sovraimpose(pixellated, pixellated_edges)å
    sovraimposed.show()
    
    edges_resized = Pixie.resize(edges, 200, 200)
    pixellated_edges_resized = Pixie.resize(pixellated_edges, 200, 200)
    sovraimposed_alt = Pixie.sovraimpose(edges_resized, pixellated_edges_resized)
